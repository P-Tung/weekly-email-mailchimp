...
Use this template to brief your AI agent. Fill in the placeholders in square brackets, then paste the full prompt to the agent. The agent must refer to sections of the mailer using **exactly** these names (they match the metadata in `cinema-email-master-template-2.html`).
